...
from app.news.adapters.common import canonicalize_url, compute_content_hash, normalize_event_status, normalize_title
from app.news.utils.timeparse import to_utc
...
class CalendarIcsAdapter(ProviderAdapter):
    ...
    def fetch(self, feed_url: str, feed_extra_config: dict, since: datetime | None) -> RawFetchResult:
        ...
        bound_asset_id = feed_extra_config.get("instrument_id")
