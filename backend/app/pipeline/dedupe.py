...
def find_near_duplicate_news(
    ...
    *,
    ...
    candidates = db.scalars(
        ...
        .where(
            NewsItemAsset.asset_id == asset_id,
...
def find_matching_event(
    db: Session, *, asset_id: str, type_: str, starts_at: datetime | None, period_label: str | None
) -> Event | None:
    query = select(Event).where(Event.asset_id == asset_id, Event.type == type_)
